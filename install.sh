...
CODEX_SKILL_DIR="${NEWS_CLI_CODEX_SKILL_DIR:-${NEWS_CLI_SKILL_DIR:-$CODEX_HOME/skills/news-cli}}"
HERMES_SKILL_DIR="${NEWS_CLI_HERMES_SKILL_DIR:-$HERMES_HOME/skills/news-cli}"
...
mkdir -p "$INSTALL_DIR" "$CODEX_SKILL_DIR" "$HERMES_SKILL_DIR"
...
curl -fsSL "$skill_url" -o "$HERMES_SKILL_DIR/SKILL.md"

echo "Installed news-cli to $INSTALL_DIR/news-cli"
echo "Installed Codex skill to $CODEX_SKILL_DIR/SKILL.md"
echo "Installed Hermes skill to $HERMES_SKILL_DIR/SKILL.md"
